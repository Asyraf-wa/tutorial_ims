...
class DashboardsController extends AppController
{
	...
	public function index()
	{
		...
		$pending_app = $applications->find()->where(['approval_status' => 1])->count();
		$pending_app_percent = $pending_app * 100 / $total_app;
		//letak 'pending_app_percent' kat compact
		...
		$this->set(compact('total_user', 'total_contact', 'total_auditlog', 'total_todo', 'user_percent', 'pending_todo_percent', 'pending_faq_percent', 'pending_contact_percent', 'userLogs', 'formattedResults', 'totalActivityByMonth', 'todo_list', 'pending_app_percent'));
	}
}
