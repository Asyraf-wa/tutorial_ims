								...
								<tbody>
									<?php foreach ($applications as $application): ?>
										<tr>
											...
											<td><?= $application->hasValue('user') ? $this->Html->link($application->user->fullname, ['controller' => 'Users', 'action' => 'profile', $application->user->slug, 'prefix' => false]) : '' ?><br /><?= h($application->matrix) ?></td>
											...
											<td><?= $application->hasValue('semester') ? $this->Html->link($application->semester->code, ['controller' => 'Semesters', 'action' => 'view', $application->semester->id]) : '' ?></td>
											<td><?= $application->hasValue('branch') ? $this->Html->link($application->branch->name, ['controller' => 'Branches', 'action' => 'view', $application->branch->id]) : '' ?></td>
											<td><?php echo date('M d, Y', strtotime($application->application_date)); ?></td>
											<td><?= h($application->company_name) ?></td>
											<td><?php echo date('M d, Y', strtotime($application->start_date)); ?></td>
											<td><?php echo date('M d, Y', strtotime($application->end_date)); ?></td>
											<td>
		...
		<div class="card bg-body-tertiary border-0 shadow mb-4">
			<div class="card-body">
				...
				<fieldset>
					...
					<div class="mb-1"><?php echo $this->Form->control('user_id', ['options' => $users, 'empty' => 'Select User', 'class' => 'form-select']); ?></div>

					<div class="mb-1"><?php echo $this->Form->control('faculty_id', ['options' => $faculties, 'empty' => 'Select a faculty/college', 'class' => 'form-select']); ?></div>
					<div class="mb-1"><?php echo $this->Form->control('program_id', ['options' => $programs, 'empty' => 'Select a program', 'class' => 'form-select']); ?></div>

					<div class="mb-1"><?php echo $this->Form->control('semester_id', ['options' => $semesters, 'empty' => 'Select a semester', 'class' => 'form-select']); ?></div>
					<div class="mb-1"><?php echo $this->Form->control('branch_id', ['options' => $branches, 'empty' => 'Select a branch', 'class' => 'form-select']); ?></div>
					<div class="mb-1"><?php echo $this->Form->control('application_date_from', ['label' => 'Application Date', 'type' => 'date']); ?>
					</div>
					<div class="mb-1"><?php echo $this->Form->control('application_date_to', ['label' => 'Application Date', 'type' => 'date']); ?>
					</div>
