...
<nav id="sidebar" class="bg-body-tertiary shadow">
    ...
    <div class="px-0">
        <ul class="list-unstyled components">
            ...
            <li class="menu-item">
                <?= $this->Html->link(__('<i class="menu-icon fa-regular fa-newspaper"></i> Application'), ['controller' => 'Applications', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
            </li>
            <?php if ($this->Identity->isLoggedIn()) { ?>
                ...
                <?php if ($this->Identity->isLoggedIn() && $this->Identity->get('user_group_id') == '1') { ?>
                    ...
                    <li class="menu-item <?= $c_name == 'Applications' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-regular fa-newspaper"></i> Application <span class="badge text-bg-warning">' .  $total_applications_pending . '</span>'), ['prefix' => 'Admin', 'controller' => 'Applications', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Faculties' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-building-columns"></i> Faculty'), ['prefix' => 'Admin', 'controller' => 'Faculties', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Programs' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-graduation-cap"></i> Program'), ['prefix' => 'Admin', 'controller' => 'Programs', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Semesters' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-regular fa-calendar-days"></i> Semester'), ['prefix' => 'Admin', 'controller' => 'Semesters', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Branches' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-regular fa-building"></i> Branch'), ['prefix' => 'Admin', 'controller' => 'Branches', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                <?php } ?>
            <?php } ?>
        </ul>
