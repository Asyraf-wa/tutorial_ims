...
class Initial extends AbstractMigration
{
    ...
    public function up(): void
    {
        $this->table('applications')
            ...
            ->addColumn('nric', 'string', [
                'default' => null,
                'limit' => 12,
                'null' => false,
            ])
            ->addColumn('matrix', 'string', [
                'default' => null,
                'limit' => 10,
                'null' => false,
            ])
            ->addColumn('pic_name', 'string', [
                'default' => null,
                'limit' => 255,
                'null' => false,
            ])
            ->addColumn('pic_email', 'string', [
                'default' => null,
                'limit' => 255,
                'null' => false,
            ])
            ...
            ->addColumn('company_street_1', 'string', [
                'default' => null,
                'limit' => 255,
                'null' => false,
            ])
            ->addColumn('company_street_2', 'string', [
                'default' => null,
                'limit' => 255,
                'null' => false,
            ])
            ->addColumn('company_postcode', 'string', [
                'default' => null,
                'limit' => 10,
                'null' => false,
            ])
            ...
            ->addColumn('approval_name', 'string', [
                'default' => null,
                'limit' => 255,
                'null' => false,
            ])
            ->addColumn('approval_post', 'string', [
                'default' => null,
                'limit' => 255,
                'null' => false,
            ])
